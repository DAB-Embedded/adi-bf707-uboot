...
#  define CONFIG_SYS_MONITOR_BASE (CONFIG_SYS_SDRAM_BASE  + (CONFIG_SYS_MAX_RAM_SIZE - CONFIG_SYS_MONITOR_LEN))
# else
...
#if CONFIG_SYS_MAX_RAM_SIZE && \
    ( (CONFIG_SYS_SDRAM_BASE - (CONFIG_SYS_MONITOR_BASE + CONFIG_SYS_MONITOR_LEN)) > CONFIG_SYS_MAX_RAM_SIZE)
# error Memory Map does not fit into configuration
#endif

/* Default/common Blackfin environment settings */
#ifndef CONFIG_LOADADDR
# define CONFIG_LOADADDR (CONFIG_SYS_SDRAM_BASE | 0x1000000)
#endif
