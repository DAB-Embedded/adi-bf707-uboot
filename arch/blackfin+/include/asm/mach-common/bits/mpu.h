...
#define PAGE_SIZE_16KB	        0x00020000	/* 16 KB page size */
#define PAGE_SIZE_64KB		0x00030000	/* 64 KB page size */
#define PAGE_SIZE_256KB		0x00040000	/* 256 KB page size */
#define PAGE_SIZE_1MB		0x00050000	/* 1 MB page size */
#define PAGE_SIZE_4MB		0x00060000	/* 4 MB page size */
#define PAGE_SIZE_16MB		0x00070000	/* 16 MB page size */
#define PAGE_SIZE_64MB		0x00080000	/* 64 MB page size */
#define PAGE_SIZE_256MB		0x00090000	/* 256 MB page size */
#define PAGE_SIZE_1GB		0x000A0000	/* 1 GB page size */
#define PAGE_SIZE_MASK		0x000F0000	/* page_size field mask */
