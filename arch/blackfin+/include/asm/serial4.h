	...
	int mux_func, int port_pin)
{
	...
	case 'B':
		bfin_write_PORTB_MUX((bfin_read_PORTB_MUX() &
			~mux_mask) | mux_func);
		bfin_write_PORTB_FER_SET(port_pin);
		break;
	}
}
...
static inline void serial_early_do_portmux(void)
{
	...
	case 0:
		serial_early_do_mach_portmux('B', PORT_x_MUX_8_MASK,
		PORT_x_MUX_8_FUNC_1, PB8); /* TX: D; mux 8; func 0; PB8 */
		serial_early_do_mach_portmux('B', PORT_x_MUX_9_MASK,
		PORT_x_MUX_9_FUNC_1, PB9); /* RX: D; mux 9; func 0; PB9 */
		break;
	case 1:
		serial_early_do_mach_portmux('B', PORT_x_MUX_8_MASK,
		PORT_x_MUX_8_FUNC_1, PB8); /* TX: D; mux 8; func 0; PB8 */
